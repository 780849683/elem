        ...
        <form role="form" method="post" action="" enctype="multipart/form-data">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" value="{{ old('shop_name') }}">
                </div>
                <div class="form-group">
                    <label>店铺分类：</label>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="img" value="" id="logo">
                    <!--dom结构部分-->
                ...
                <div class="form-group">
                    <div class="checkbox">
                        ...
                        <label>
                            <input type="checkbox" name="on_time" value="0" @if(old('time')==1) checked @endif> 准时送达
                        </label>

                        <label>
                            <input type="checkbox" name="fengniao" value="0" @if(old('fengniao')==1) checked @endif> 蜂鸟配送
                        </label>

                        <label>
                            <input type="checkbox" name="bao" value="" @if(old('bao')==1) checked @endif> 保
                        </label>

                        <label>
                            <input type="checkbox" name="piao" value="" @if(old('piao')==1) checked @endif> 票
                        </label>

                        <label>
                            <input type="checkbox" name="zhun" value="" @if(old('zhun')==1) checked @endif> 准
                        </label>
                    </div>
                </div>
